          ...
          <div class="header-big">
              <div class="header-items-active">
                  <div class="single-header-item bg_cover"
                      style=" background-image: url({{url('user/assets/images/header-1/header-big-1.jpg')}});height:600px;width:700px " >
                  ...
                  <div class="single-header-item bg_cover"
                      style="background-image: url({{url('user/assets/images/header-1/header-big-2.jpg')}});">
                      <div class="header-item-content">
                          <h3 class="title">Don’t say it with flowers: A NOMOS watch is a gift that lasts</h3>
                          <a href="javascript:void(0)" class="link">Our Valentine's Day collection</a>
                      </div>
                  ...
                  <div class="single-header-item bg_cover"
                      style="background-image: url({{url('user/assets/images/header-1/header-big-1.jpg')}});">
                      <div class="header-item-content">
                          <h3 class="title">Don’t say it with flowers: A NOMOS watch is a gift that lasts</h3>
                          <a href="javascript:void(0)" class="link">Our Valentine's Day collection</a>
                      </div>
                          ...
                          <div class="product-image">
                              ...
                              <div class="product-active">
                                  <div class="product-item active">
                                      <img src="{{url('user/assets/images/product-1/product-1.jpg')}}" alt="product">
                                  </div>
                                  <div class="product-item">
                                      <img src="{{url('user/assets/images/product-1/product-2.jpg')}}" alt="product">
                                  </div>
                              </div>
                  ...
                  <div class="col-lg-4 col-sm-6">
                      <div class="product-style-1 mt-30">
                          <div class="product-image">
                              ...
                              <div class="product-active">
                                  <div class="product-item active">
                                      <img src="{{url('user/assets/images/product-1/product-5.jpg')}}" alt="product">
                                  </div>
                                  <div class="product-item">
                                      <img src="{{url('user/assets/images/product-1/product-6.jpg')}}" alt="product">
                                  </div>
                              </div>
                              <a class="add-wishlist" href="javascript:void(0)">
                                  <i class="mdi mdi-heart-outline"></i>
                  ...
                  <div class="col-lg-4 col-sm-6">
                      <div class="product-style-1 mt-30">
                          <div class="product-image">
                              <div class="product-active">
                                  <div class="product-item active">
                                      <img src="{{url('user/assets/images/product-1/product-3.jpg')}}" alt="product">
                                  </div>
                                  <div class="product-item">
                                      <img src="{{url('user/assets/images/product-1/product-4.jpg')}}" alt="product">
                                  </div>
                              </div>
                              <a class="add-wishlist" href="javascript:void(0)">
                                  <i class="mdi mdi-heart-outline"></i>
                  ...
                  <div class="col-lg-4 col-sm-6">
                      <div class="product-style-1 mt-30">
                          <div class="product-image">
                              <div class="product-active">
                                  <div class="product-item active">
                                      <img src="{{url('user/assets/images/product-1/product-7.jpg')}}" alt="product">
                                  </div>
                                  <div class="product-item">
                                      <img src="{{url('user/assets/images/product-1/product-8.jpg')}}" alt="product">
                                  </div>
                              </div>
                              <a class="add-wishlist" href="javascript:void(0)">
                                  <i class="mdi mdi-heart-outline"></i>
                  ...
                  <div class="col-lg-4 col-sm-6">
                      <div class="product-style-1 mt-30">
                          <div class="product-image">
                              <div class="product-active">
                                  <div class="product-item active">
                                      <img src="{{url('user/assets/images/product-1/product-9.jpg')}}" alt="product">
                                  </div>
                                  <div class="product-item">
                                      <img src="{{url('user/assets/images/product-1/product-10.jpg')}}" alt="product">
                                  </div>
                              </div>
                              <a class="add-wishlist" href="javascript:void(0)">
                                  <i class="mdi mdi-heart-outline"></i>
                  ...
                  <div class="col-lg-4 col-sm-6">
                      <div class="product-style-1 mt-30">
                          <div class="product-image">
                              ...
                              <div class="product-active">
                                  <div class="product-item active">
                                      <img src="{{url('user/assets/images/product-1/product-11.jpg')}}" alt="product">
                                  </div>
                                  <div class="product-item">
                                      <img src="{{url('user/assets/images/product-1/product-12.jpg')}}" alt="product">
                                  </div>
                              </div>
                              <a class="add-wishlist" href="javascript:void(0)">
                                  <i class="mdi mdi-heart-outline"></i>
                  ...
                  <div class="col-lg-6">
                      <div class="product-style-7 mt-30">
                          <div class="product-image">
                              <div class="product-active">
                                  <div class="product-item active">
                                      <img src="{{url('user/assets/images/product-4/product-1.jpg')}}" alt="product">
                                  </div>
                                  <div class="product-item">
                                      <img src="{{url('user/assets/images/product-4/product-2.jpg')}}" alt="product">
                                  </div>
                              </div>
                          </div>
                          <div class="product-content">
                              ...
                              <a href="javascript:void(0)" class="main-btn primary-btn">
                                  <img src="{{url('user/assets/images/icon-svg/cart-4.svg')}}" alt="">
                                  Add to Cart
                              </a>
                          </div>
                      </div>
                  ...
                  <div class="col-lg-6">
                      <div class="product-style-7 mt-30">
                          <div class="product-image">
                              <div class="product-active">
                                  <div class="product-item active">
                                      <img src="{{url('user/assets/images/product-4/product-3.jpg')}}" alt="product">
                                  </div>
                                  <div class="product-item">
                                      <img src="{{url('user/assets/images/product-4/product-4.jpg')}}" alt="product">
                                  </div>
                              </div>
                          </div>
                          <div class="product-content">
                  ...
                  <div class="col-lg-6">
                      <div class="product-style-7 mt-30">
                          <div class="product-image">
                              ...
                              <div class="product-active">
                                  <div class="product-item active">
                                      <img src="{{url('user/assets/images/product-4/product-5.jpg')}}" alt="product">
                                  </div>
                                  <div class="product-item">
                                      <img src="{{url('user/assets/images/product-4/product-6.jpg')}}" alt="product">
                                  </div>
                              </div>
                          </div>
                          <div class="product-content">
                  ...
                  <div class="col-lg-6">
                      <div class="product-style-7 mt-30">
                          <div class="product-image">
                              <div class="product-active">
                                  <div class="product-item active">
                                      <img src="{{url('user/assets/images/product-4/product-7.jpg')}}" alt="product">
                                  </div>
                                  <div class="product-item">
                                      <img src="{{url('user/assets/images/product-4/product-8.jpg')}}" alt="product">
                                  </div>
                              </div>
                          </div>
                          <div class="product-content">
                  ...
                  <div class="col-lg-6">
                      <div class="product-style-7 mt-30">
                          <div class="product-image">
                              <div class="product-active">
                                  <div class="product-item active">
                                      <img src="{{url('user/assets/images/product-4/product-9.jpg')}}" alt="product">
                                  </div>
                                  <div class="product-item">
                                      <img src="{{url('user/assets/images/product-4/product-10.jpg')}}" alt="product">
                                  </div>
                              </div>
                          </div>
                          <div class="product-content">
                  ...
                  <div class="col-lg-6">
                      <div class="product-style-7 mt-30">
                          <div class="product-image">
                              ...
                              <div class="product-active">
                                  <div class="product-item active">
                                      <img src="{{url('user/assets/images/product-4/product-11.jpg')}}" alt="product">
                                  </div>
                                  <div class="product-item">
                                      <img src="{{url('user/assets/images/product-4/product-12.jpg')}}" alt="product">
                                  </div>
                              </div>
                          </div>
                          <div class="product-content">
